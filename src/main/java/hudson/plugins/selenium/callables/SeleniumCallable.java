...
public class SeleniumCallable implements FileCallable<String> {
	...
	private static final Logger LOGGER = Logger
			.getLogger(SeleniumCallable.class.getName());
	...
	public SeleniumCallable(FilePath jar, String nodehost, String masterName,
			int masterPort, String nodeName, TaskListener listener,
			String confName, SeleniumRunOptions options)
		...
		config = confName;
		defaultArgs = new String[] { ROLE_PARAM, ROLE_NODE_VALUE, HOST_PARAM,
				nodehost, HUB_PARAM,
	...
	public String invoke(File f, VirtualChannel channel) throws IOException {
		...
		try {
			...
			List<String> arguments = new ArrayList<String>(options
					.getSeleniumArguments().size());
